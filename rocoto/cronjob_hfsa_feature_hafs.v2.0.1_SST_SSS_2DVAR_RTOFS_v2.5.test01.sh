...
HOMEhafs=${HOMEhafs:-/work/noaa/hwrf/save/maristiz/hafsv2_develop_July9_SST_SSS_2DVAR_RTOFS_v2.5.test01}
...
confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_hfsa_dev ../parm/hfsa_dev.conf"
 ...
 ./run_hafs.py ${opts} 2024081200 05L HISTORY ${confopts} \
  config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=no
